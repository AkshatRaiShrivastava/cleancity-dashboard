...
export const getReports = async (filters = {}) => {
  try {
    ...
    if (filters.sortBy) {
      reportsQuery = query(reportsQuery, orderBy(filters.sortBy, filters.sortDirection || "desc"))
    } else {
...
export const getDashboardStats = async () => {
  try {
    ...
    const inProgressQuery = query(collection(db, "reports"), where("status", "==", "in_progress"))
